    ...
    <Layout>
      ...
      >
        ...
        <p>
          ...
          "Condiciones de Uso") del sitio web kolyy.com (en adelante, "el Sitio
          Web"). El acceso y uso de este Sitio Web implica la aceptación de las
          Condiciones de Uso así como la Política de Privacidad de Datos y la
        ...
        <h6>Derechos de propiedad intelectual e industrial</h6>
        <p>
          ...
          contacto con el Titular en la dirección [ ] acreditando ser el titular
          de aquellos derechos que considere infringidos. <br />
        </p>
        ...
        <h6>Enlaces a otros sitios web</h6>
        <p>
          ...
          dirigir un correo electrónico a team@kolyy.com exponiendo estos
          hechos.
        </p>{" "}
        <br />
        <h6>Enlaces al Sitio Web desde sitios web ajenos</h6>
        <p>
          El Sitio Web puede incluir enlaces a otros sitios web titularidad de
          terceros sin que ello signifique que el Titular muestre su conformidad
          con su contenido, que realice algún tipo de promoción o que exista
        ...
        <h6>Enlaces a otras plataformas y redes sociales</h6>
        <p>
        ...
        <h6>Continuidad y suspensión del Sitio Web </h6>
        <p>
        ...
        <p>
          ...
          tratados conforme a la <Link to="/datos">Política de Privacidad</Link>{" "}
